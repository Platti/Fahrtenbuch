    ...
    public View getView(int _pos, View _view, ViewGroup _parent) {
        ...
        iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertbox.setMessage(R.string.del_usr_sure);
                alertbox.setPositiveButton(R.string.del, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mLoadingDialog.setMessage(String.valueOf(R.string.del_dots));
                        mLoadingDialog.show();
                        App.database.deleteMapping(driver.getUsername(), App.car.getLicensePlate(), new DeleteCallback() {
                            ...
                            public void done(ParseException e) {
                               mLoadingDialog.dismiss();
                                if(e == null){
                                    Toast.makeText(mActivity, R.string.del_usr_success, Toast.LENGTH_LONG).show();
                                } else {
                                    Toast.makeText(mActivity, R.string.error_dots + e.getMessage(), Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                    }
